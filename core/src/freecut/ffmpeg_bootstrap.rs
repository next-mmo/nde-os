...
//!
//! End users should never need to install FFmpeg manually. This module follows
//! the same pattern as [`crate::uv_env::ensure_uv`]: check bundled → check
//! system PATH → auto-download static binaries into `base_dir/.ffmpeg/`.
//!
//! Download sources:
