...
export type LauncherSection = "overview" | "catalog" | "installed" | "running" | "server" | "command-center" | "chat" | "playground" | "model-settings" | "plugins" | "channels" | "mcp-tools" | "skills" | "knowledge" | "code-editor";
...
function getSavedLauncherSection(): LauncherSection {
  try {
    ...
    const validSections: LauncherSection[] = ["overview", "catalog", "installed", "running", "server", "command-center", "chat", "playground", "model-settings", "plugins", "channels", "mcp-tools", "skills", "knowledge", "code-editor"];
